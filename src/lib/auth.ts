...
const secretKey = process.env.AUTH_SECRET || 'default-secret-key-change-in-production';
 ...
 * 認証状態をチェック
 */
export async function checkAuth(): Promise<{ authenticated: boolean; ip?: string }> {
